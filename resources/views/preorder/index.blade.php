...
<div class="content-wrapper bg-white">
          <div class="row">
            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Pre-order Table</h4>
                    ...
                    <div class="tab-content" id="myTabContent">
                      <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab"><table class="table table-striped">
                        ...
                        @foreach ($preorders as $preorder)
                          <tr>
                          <td>
                            <input type="checkbox" name="ids" class="checkBoxClass" value="{{ $preorder->id }}" />
                          </td>
                            <td>
                            <div style="width: 200px;">
                              <img src="{{ asset('storage/' . $preorder->gambar) }}" alt="No Image" class="img-fluid mt-3">
                          </div>
                            </td>
                            <td>
                              {{ $preorder->judul}}
                            ...
                            <a class="btn rounded-pill btn-warning" href="{{ route('preorder.edit', $preorder->id)}}">Edit</a>
                            @csrf
                            @method('DELETE')
