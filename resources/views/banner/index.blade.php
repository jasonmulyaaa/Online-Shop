                    ...
                    <div class="tab-content" id="myTabContent">
                      <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab"><table class="table table-striped">
                        ...
                        @foreach ($banners as $banner)
                          <tr>
                          <td>
                            <input type="checkbox" name="ids" class="checkBoxClass" value="{{ $banner->id }}" />
                          </td>
                            <td>
                            <div style="width: 200px;">
                              <img src="{{ asset('storage/' . $banner->gambar) }}" alt="No Image" class="img-fluid mt-3">
                          </div>
                            </td>
                            <td>
                              {{ $banner->judul}}
                            ...
                            <a class="btn rounded-pill btn-warning" href="{{ route('banner.edit', $banner->id)}}">Edit</a>
                            @csrf
                            @method('DELETE')
                      ...
                      <div class="pull-right">
                        <a href="#" class="btn btn-danger" id="deleteAllSelectedBanner" onclick="location.reload()">Delete Selected</a>
                    </div>
